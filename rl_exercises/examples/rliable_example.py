...
week_script_path = pathlib.Path(__file__).parent.resolve()

n_seeds = 2
# Read data from different runs
# This is the toy data, you can also build a proper loop over your own runs.
df_s0 = pd.read_csv(week_script_path / "demo_data_seed_0.csv")
df_s1 = pd.read_csv(week_script_path / "demo_data_seed_1.csv")
...
plt.tight_layout()
# save figure to file
plt.savefig(week_script_path / "iqm_sample_efficiency_curve.png")
plt.close()
